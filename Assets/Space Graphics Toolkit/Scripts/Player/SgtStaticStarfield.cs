...
public class SgtStaticStarfield : SgtStarfield
{
	...
	public static SgtStaticStarfield CreateStaticStarfield(Transform parent = null)
	{
		return CreateStaticStarfield(parent, Vector3.zero, Quaternion.identity, Vector3.one);
	}
	
	public static SgtStaticStarfield CreateStaticStarfield(Transform parent, Vector3 localPosition, Quaternion localRotation, Vector3 localScale)
	{
		var gameObject = SgtHelper.CreateGameObject("Static Starfield", parent, localPosition, localRotation, localScale);
	...
	{
		var starfield = CreateStaticStarfield(SgtHelper.GetSelectedParent());
